 ...
 */
final class Version20221229170942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recette (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, time INT DEFAULT NULL, nb_personne INT DEFAULT NULL, difficulte INT DEFAULT NULL, description LONGTEXT NOT NULL, prix DOUBLE PRECISION DEFAULT NULL, is_favori TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
